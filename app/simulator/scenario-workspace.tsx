...
export default function ScenarioWorkspace() {
  ...
  return <div className={styles.workspace}>
    ...
    <section className={styles.savedSection} aria-labelledby="scenarios-heading">
      ...
      {snapshot === undefined ? <Skeleton label="Preparing your saved scenarios" /> : scenarios.length === 0 && !storageError ? <div className={styles.empty}><BrandMark /><h3>Your next possibility starts here.</h3><p>Change the values above, then save a scenario. Keep both plans together and revisit the choices that matter to you.</p><span>Private to this browser. No account needed.</span></div> : <div className={styles.savedGrid}>{scenarios.map((scenario) => {
