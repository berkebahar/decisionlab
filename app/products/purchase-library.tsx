...
function ReviewEditor({ record }: { record: ProductRecord }) {
  ...
  return <form className="purchase-review-form" onSubmit={async event => { event.preventDefault();
