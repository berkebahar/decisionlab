...
export default function InsightsWorkspace() {
  ...
  if (loading) return <div className={styles.workspace}><Skeleton label="Loading your insights" /></div>;
