...
export default function Home() {
  ...
  return <div className="editorial-home">
    ...
    <section className="editorial-section editorial-receipt-section" aria-labelledby="receipt-preview-heading" id="receipt-preview">
      ...
      <div className="container editorial-receipt-layout">
        <div className="editorial-section-copy">
          ...
          <p>Purchase price plus ownership costs, less expected resale.</p>
    ...
    <section className="editorial-section container editorial-comparison" aria-labelledby="comparison-heading">
      <div className="editorial-section-heading"><p className="eyebrow">04 / A matter of perspective</p><h2 id="comparison-heading">Different assumptions.<br />Different costs.</h2><p>Compare the same measures, using your own assumptions.</p></div>
      ...
      <div className="editorial-comparison-footer"><p>Fictional estimates, not market prices. Different assumptions explain the trade-offs; neither option is a universal winner.</p><Link href="/compare?demo=0" className="text-link">Explore this comparison <Icon name="arrow" size={17} /></Link></div>
    ...
    <section className="editorial-section editorial-queue" aria-labelledby="queue-heading" data-pointer-light>
      ...
      <div className="container editorial-queue-layout">
        <div className="editorial-section-copy"><p className="eyebrow">05 / Time to consider</p><h2 id="queue-heading">Give the decision<br />some space.</h2><p>Save a receipt and choose a date to reconsider.</p><Link href="/queue" className="editorial-text-link">Open your queue <span aria-hidden="true">→</span></Link></div>
        <ol className="editorial-queue-steps" aria-label="How the decision queue works"><li><span aria-hidden="true">01</span><div><h3>Save your receipt</h3><p>Keep the assumptions behind the decision.</p></div></li><li><span aria-hidden="true">02</span><div><h3>Give it a day. Or seven.</h3><p>Choose a date that works for you.</p></div></li><li><span aria-hidden="true">03</span><div><h3>Return with a clearer head</h3><p>Revisit your date in the queue. No notifications.</p></div></li></ol>
      </div>
    </section>

    <section className="editorial-section container editorial-reflection" aria-labelledby="reflection-heading">
      <div className="editorial-section-heading"><p className="eyebrow">06 / After the purchase</p><h2 id="reflection-heading">What did you<br />actually get from it?</h2><p>Compare your original estimate with the costs and use you record.</p></div>
