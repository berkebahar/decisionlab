...
export const metadata: Metadata = { title: "GoalLens Calculator", description: "Explore a purchase, recurring spending, or two options side by side. See the impact on your savings goal and save your comparison." };

export default function GoalLensPage() {
  return <div className="container calculator-page">
    <div className={styles.pageIntro}><PageHeading page="GoalLens" eyebrow="01 / THE DECISION WORKSPACE" title="See beyond the price tag.">A purchase has a price. It also has a timeline. Connect everyday spending to your bigger goals and see the trade-off, in real time.</PageHeading><Link className={styles.headerLink} href="/dashboard">Open your dashboard <Icon name="arrow" size={17} /></Link></div>
    <div className="calculator-workspace"><Suspense fallback={<Skeleton label="Loading GoalLens…" />}><CalculatorWorkspace /></Suspense></div>
